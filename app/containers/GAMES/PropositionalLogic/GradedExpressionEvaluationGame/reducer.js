/*
 *
 * GradedExpressionEvaluationGame reducer
 *
 */
...
const gradedExpressionEvaluationGameReducer = (state = initialState, action) =>
  produce(state, draft => {
    switch (action.type) {
...
export default gradedExpressionEvaluationGameReducer;
