/*
 *
 * GradedFindFeatureWithHighestIg reducer
 *
 */
...
const gradedFindFeatureWithHighestIgReducer = (state = initialState, action) =>
  produce(state, draft => {
    switch (action.type) {
...
export default gradedFindFeatureWithHighestIgReducer;
