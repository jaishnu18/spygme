...
import GameComponent from 'components/GAMES/DecisionTreeLearning/GradedFindDecisionTreeOutputComponent';
import makeSelectGradedFindDecisionTreeOutput from './selectors';
...
export function GradedFindDecisionTreeOutput(props) {
  useInjectReducer({ key: 'gradedFindDecisionTreeOutput', reducer });
  useInjectSaga({ key: 'gradedFindDecisionTreeOutput', saga });
  ...
  return (
    <div>
      <Helmet>
        <title>GradedFindDecisionTreeOutput</title>
        <meta
          name="description"
          content="Description of GradedFindDecisionTreeOutput"
        />
      </Helmet>
...
GradedFindDecisionTreeOutput.propTypes = {
...
const mapStateToProps = createStructuredSelector({
  state: makeSelectGradedFindDecisionTreeOutput(),
});
