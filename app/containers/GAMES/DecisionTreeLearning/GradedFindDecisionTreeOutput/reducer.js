/*
 *
 * GradedFindDecisionTreeOutput reducer
 *
 */
...
const gradedFindDecisionTreeOutputReducer = (state = initialState, action) =>
  produce(state, draft => {
    switch (action.type) {
...
export default gradedFindDecisionTreeOutputReducer;
