...
import GameComponent from 'components/GAMES/DecisionTreeLearning/GradedWhatIsTheDecisionComponent';
import makeSelectGradedWhatIsTheDecision from './selectors';
...
export function GradedWhatIsTheDecision(props) {
  useInjectReducer({ key: 'gradedWhatIsTheDecision', reducer });
  useInjectSaga({ key: 'gradedWhatIsTheDecision', saga });
  ...
  return (
    <div>
      <Helmet>
        <title>GradedWhatIsTheDecision</title>
        <meta
          name="description"
          content="Description of GradedWhatIsTheDecision"
        />
      </Helmet>
...
GradedWhatIsTheDecision.propTypes = {
...
const mapStateToProps = createStructuredSelector({
  state: makeSelectGradedWhatIsTheDecision(),
});
