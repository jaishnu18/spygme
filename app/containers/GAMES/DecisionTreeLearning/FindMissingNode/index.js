...
import GameComponent from 'components/GAMES/DecisionTreeLearning/FindMissingNodeComponent';
import { start, end } from 'utils/timerFunctions';
import moment from 'moment';

import { useInjectSaga } from 'utils/injectSaga';
import { useInjectReducer } from 'utils/injectReducer';
import makeSelectFindMissingNode from './selectors';
...
export function FindMissingNode(props) {
  useInjectReducer({ key: 'findMissingNode', reducer });
  useInjectSaga({ key: 'findMissingNode', saga });
  ...
  const submit = value => {
    ...
    gameData.response = {
      ...
      missingNode: gameData.missingNode,
      answer: value.output,
    };
  ...
  return (
    <div>
      <Helmet>
        <title>FindMissingNode</title>
        <meta name="description" content="Description of FindMissingNode" />
      </Helmet>
...
const mapStateToProps = createStructuredSelector({
  state: makeSelectFindMissingNode(),
});
