...
import makeSelectFindFeatureWithHighestIg from './selectors';
...
export function FindFeatureWithHighestIg(props) {
  useInjectReducer({ key: 'findFeatureWithHighestIg', reducer });
  useInjectSaga({ key: 'findFeatureWithHighestIg', saga });
  ...
  return (
    <div>
      <Helmet>
        <title>FindFeatureWithHighestIg</title>
        <meta
          name="description"
          content="Description of FindFeatureWithHighestIg"
        />
      </Helmet>
      ...
      {gameData && (
        <>
          <GameBar
            name="Find Feature With Highest Information Gain"
            level={level}
...
FindFeatureWithHighestIg.propTypes = {
...
const mapStateToProps = createStructuredSelector({
  state: makeSelectFindFeatureWithHighestIg(),
});
