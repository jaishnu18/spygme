/*
 *
 * CrosswordBacktrackingTreeGame reducer
 *
 */
...
const crosswordBacktrackingTreeGameReducer = (state = initialState, action) =>
  produce(state, draft => {
    switch (action.type) {
...
export default crosswordBacktrackingTreeGameReducer;
