/*
 *
 * GradedCrosswordBacktackingTree reducer
 *
 */
...
const gradedCrosswordBacktackingTreeReducer = (state = initialState, action) =>
  produce(state, draft => {
    switch (action.type) {
...
export default gradedCrosswordBacktackingTreeReducer;
